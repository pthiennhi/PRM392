...
public class CourseActivity extends AppCompatActivity {
    ...
    btnCreate.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        if (newCourse.length() == 0 || checkCourseExisted(newCourse)) {
          ...
          editText.setText("");
          Toast.makeText(CourseActivity.this, "Create new course successfully",
    ...
    btnUpdate.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        if (checkPosition() == true) {
          ...
          InputMethodManager imm = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
          imm.hideSoftInputFromWindow(editText.getWindowToken(), 0);
          Toast.makeText(CourseActivity.this, "Update course successfully",
              Toast.LENGTH_LONG).show();
          editText.setText("");
        } else {
    ...
    btnDelete.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        if (checkPosition() == true) {
          ...
          arrayAdapter.notifyDataSetChanged();
          position = -1;
          Toast.makeText(CourseActivity.this, "Delete course successfully",
              Toast.LENGTH_LONG).show();
          editText.setText("");
        } else {
          showNotification("update");
  ...
  private void showNotification(String type) {
    switch (type) {
      case "create":
        Toast.makeText(this, "Please input new course",
            Toast.LENGTH_LONG).show();
        break;
      case "update":
